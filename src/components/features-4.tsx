        ...
        <section className="py-12 md:py-20">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-balance text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">The foundation for creative teams management</h2>
                    <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground">Lyra is evolving to be more than just the models. It supports an entire to the APIs and platforms helping developers and businesses innovate.</p>
                </div>
