          ...
          <Card className="border-0 bg-foreground/10 backdrop-blur-lg shadow-2xl">
            <CardHeader className="text-center pb-8">
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                <span className="text-5xl md:text-6xl font-bold text-accent">$29</span>
            ...
            <CardContent className="space-y-6">
              ...
              {/* Special Offers */}
              <div className="bg-accent-100 border border-accent-300 rounded-lg p-4 mt-6">
                <div className="flex items-center gap-2 mb-2">
                  <Zap className="w-5 h-5 text-accent" />
                  <span className="text-accent font-semibold">Special Launch Bonuses</span>
                </div>
        ...
        <div className="text-center">
          ...
          <div className="mt-12 pt-8 border-t border-foreground/10">
            <p className="text-foreground/80 text-lg">
              Trusted by <span className="font-bold text-accent">1000+</span> students across Nepal
            </p>
