  ...
  return (
    <section className="bg-background relative">
      <div className="container z-10 mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        <div className="flex justify-center gap-4 sm:gap-6 mt-6 sm:mt-8 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[600px] sm:max-h-[740px] overflow-hidden">
